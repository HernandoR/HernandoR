...
<!-- RECENT_REPOS:START -->
- [HernandoR/duck-viewer](https://github.com/HernandoR/duck-viewer) — Duck Viewer — an unofficial VS Code extension for querying data files with the DuckDB engine. Not affiliated with DuckDB Labs. _(TypeScript, updated: 2026-09-14)_
- [HernandoR/zbrew](https://github.com/HernandoR/zbrew) — A 5-20x faster experimental Homebrew alternative _(Rust, updated: 2026-09-14)_
...
- [HernandoR/MrRSS](https://github.com/HernandoR/MrRSS) — A modern, cross-platform, and free AI RSS reader. 一个现代化、跨平台且免费的 AI RSS 阅读器. _(Go, updated: 2026-09-15)_
